(() => {
  ...
  const configs = {
    friday: {
      ...
      trafficDecisions: [
        ["北京南站 → 首都宾馆", "地铁", "门到门45—55分钟", "G40于17:41到站，正逢周五晚高峰；4人带2只大箱或4只小箱，默认走4号线—2号线更稳。", "若要打车，普通五座车存在装不下风险；仅在已叫到六/七座车，或决定分乘两车，且预计到店不超过35分钟时切换。"],
      ...
      switches: [
        ["17:50", "出站查看两种预计时间", "默认直接进地铁；打车只在六/七座车或分乘两车已落实，且预计到酒店不超过35分钟时成立。"],
        ["19:00", "才完成入住", "直接执行正阳门—北京坊—杨梅竹压缩线，不再增加大栅栏回折。"],
        ["19:30", "才从酒店出发", "只走北京坊—杨梅竹；不再为了补景点推迟晚饭。"],
        ["20:00", "首选仍不能落座", "立即切到下一家；21:10开始回酒店。"],
        ["21:10", "统一结束", "导航显示步行超过20分钟就打车，21:30前回房。"]
      ],
      checks: [
        ["train", "核对G40到站与行李", "杭州东13:00出发、北京南17:41到达；4人按2只大箱或4只小箱准备，普通五座车可能装不下。"],
      ...
      copy: "周五 9月11日\nG40于17:41到北京南站；4人带行李默认4号线到宣武门，换2号线到崇文门，再步行到首都宾馆。普通五座车可能装不下；只有六/七座车或分乘两车已落实且预计到店≤35分钟时才打车。约19:00轻装出发，走正阳门—北京坊—杨梅竹斜街压缩线。20:00仍不能落座就切下一家。21:10统一开始回酒店，21:30前回房。"
    },
    saturday: {
      ...
      checks: [
        ...
        ["concert-seat", "演唱会座位已确认", "L区150通道，一层31排16—19号，4人连座；入场后按场内指引找150通道。", true],
        ["concert-entry", "演唱会检票入口与禁限带", "票面暂未显示指定检票口；临行前查看主办方通知，现场不根据通道号自行猜入口；17:00进入实名核验。"],
      ...
      copy: "周六 9月12日\n03:30起床，04:00离店，步行到广场东侧路北安检03；升旗预约时段03:30—04:52，05:52升旗。06:30天兴居、07:00锦芳，07:25去午门。08:30—12:30故宫：中轴线、钟表馆、珍宝馆、御花园；门票均已约。午饭白记优先，13:15未落座切平安锅贴，再切席上喳喳。13:50回房午休，14:25吃外卖，15:05左右离店。17:00到检票区，19:00演出。22:50已进入交通才去什刹海；23:10电话确认夜宵。"
    },
    sunday: {
